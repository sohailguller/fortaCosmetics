        ...
        <section className="grid grid-cols-1 md:grid-cols-2 min-h-[70vh]">
          <div className="bg-white p-8 md:p-20 flex flex-col justify-center items-start">
            <motion.div
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-10 max-w-md">We're building a community that's excited about showing up for their skin and making the most of every day.
