...
export default function HeroSection() {
  return (
    <section className="relative h-[60vh] md:h-screen w-full overflow-hidden mb-0">
        <div className="fixed top-0 left-0 right-0 h-[60vh] md:h-screen flex z-0">
        <img
      ...
      <div className="fixed top-0 left-0 right-0 h-[60vh] md:h-screen bg-gradient-to-t from-black/50 via-black/10 to-transparent md:bg-black/10 z-0" />
