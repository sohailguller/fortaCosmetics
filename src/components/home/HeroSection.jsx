...
export default function HeroSection() {
  return (
    <section className="relative h-[70vh] md:h-screen w-full overflow-hidden bg-[#F5F5F5]">
      <div className="fixed top-0 left-0 right-0 h-[70vh] md:h-screen flex -z-10">
        <img
      ...
      <div className="fixed top-0 left-0 right-0 h-[70vh] md:h-screen bg-gradient-to-t from-black/50 via-black/10 to-transparent md:bg-black/10 -z-10" />
