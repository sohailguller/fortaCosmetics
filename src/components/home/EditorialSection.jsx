    ...
    <section className="flex flex-col md:grid md:grid-cols-2 bg-[#F5F5F5] w-full max-w-full overflow-hidden">
      ...
      <div className="flex flex-col justify-center p-6 md:p-20 bg-[#EBEBEB] w-full max-w-full z-10">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 uppercase leading-tight break-words hyphens-auto">
          Makeup that <br className="hidden md:block" />works with <br className="hidden md:block" />your sweat.
        </h2>
        <p className="text-gray-600 mb-8 max-w-md leading-relaxed break-words">
          When you use effective, performance-tested products that are formulated for motion, the result is simple: a look that lasts as long as you do.
        </p>
